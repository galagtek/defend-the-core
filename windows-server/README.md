...
(VLAN 30, 10.10.50.20). Gère l'identité et la résolution de noms des serveurs.

## Pré-requis

- VM Windows Server 2022 (2 vCPU, 4 Go RAM, 40 Go disque)
- Réseau interne VirtualBox `vbox-vlan30`
- IP statique : 10.10.50.20 / Passerelle : 10.10.30.1
...
```bash
ssh -J bastion Administrator@10.10.50.20
```
